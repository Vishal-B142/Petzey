...
const AllPets = () => {
  ...
  //Getting All Pet details
  const getAllPet = async () => {
    try {
      axios
        .get("https://petzeypett01.azurewebsites.net/api/patient")
        .then((response) => {
  ...
  //Getting particular pet details
  const onDelete = async (petId) => {
    axios
      .delete(`https://petzeypett01.azurewebsites.net/api/patient/${petId}`)
      .then(() => {
        getAllPet();
      });
  };
